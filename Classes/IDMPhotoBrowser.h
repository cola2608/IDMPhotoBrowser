...
@protocol SMBProtocol <NSObject>
@optional
- (BOOL)deleteFileWithFilePath:(NSURL *)filePath;
- (BOOL)downloadFileWithFilePath:(NSURL *)filePath;
- (void)showInformation:(NSURL *)filePath;
- (BOOL)deleteLocalFileWithName:(NSString *)fileName;
- (void)showPhotoRemotely: (NSURL*)url;
...
//delegate
@property (weak) id <SMBProtocol> SMBDelegate;
@property (nonatomic) BOOL isLocalFile;

//Information
@property (nonatomic) NSArray *TOSMBFile;
